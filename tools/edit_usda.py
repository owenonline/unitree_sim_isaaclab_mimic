...
def modify_instanceable_flag(file_path):
    ...
    # 保存修改后的内容
    with open('/home/unitree/newDisk/URDF/urdf-to-usd/g1withinspire_hand_usd/demo2.usda', 'w', encoding='utf-8') as f:
        f.writelines(modified_lines)

# 使用方法
modify_instanceable_flag('/home/unitree/newDisk/URDF/urdf-to-usd/g1withinspire_hand_usd/demo.usda')  # 替换为你的实际文件路径
